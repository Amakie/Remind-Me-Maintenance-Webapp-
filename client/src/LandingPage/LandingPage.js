...
function LandingPage() {
    ...
    return (
        <div className="bg-cover text-gray-200 mt-[70px] flex flex-col bg-cente flex-grow min-h-screen" style={{ backgroundImage: `url(${bg_image})` }}>
            ...
            <div className="px-5 md:px-10 mt-5">
                <Link to={'/register'} className="bg-burgundy px-3 py-2 w-fit rounded-full items-center flex flex-row">
                    <div className="rounded-full bg-white text-white">--</div>
